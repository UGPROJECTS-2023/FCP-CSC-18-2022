...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginFailed = "index fail.php";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
	...
	&nbsp;
	<div id="Layer2"><img src="image/oo.JPG" width="384" height="300" /></div>
	<br />
	&nbsp;<br />
    ...
    <div id="Layer1">
      <form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
        <table width="269" height="190" border="5" bordercolor="#99CC66">
            ...
            <tr>
              <td colspan="2" bgcolor="#D5EDB3"><div align="center" class="style10"><a href="new account.php">Create New Account</a></div></td>
            </tr>
          </table>
        </form>
    </div></td>
